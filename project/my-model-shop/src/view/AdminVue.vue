<template>
    <div class="container_admin">
        <HeaderVue>
            <div class="introduce">
                ...
                <div class="box-head-right">
                    <div class="btn-product-management btn-form-management">Sản phẩm</div>
        ...
        <div class="content">
            <div class="titlePage">Quản lý sản phẩm</div>
            <PageAdminContent></PageAdminContent>
            <ProductManager></ProductManager>
        </div>
    </div>
</template>
<script>
import PageAdminContent from "@/contents/PageAdminContent.vue"
import HeaderVue from "@/layouts/HeaderVue.vue"
import OrderManagement from "@/contents/OrderManagement.vue"
import ProductManager from "@/contents/ProductManager.vue";
import { useRouter } from "vue-router";
import { ref } from 'vue';
import axios from 'axios';
export default {
    components: {
        HeaderVue,PageAdminContent, ProductManager
    },
    setup(){
