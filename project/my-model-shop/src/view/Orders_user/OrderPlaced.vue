                ...
                <ul class="order_product-list">
                    <li>
                        ...
                        <div  class="change">
                            ...
                            <div v-if="data.status !== 'Đang giao hàng'" @click="deleteOrder(data.order_id, index)" class="delete">Hủy đơn</div>
                        </div>
                    </li>
                </ul>
...
export default {
    ...
    setup() {
        onMounted(() => {
            store.dispatch("getProductsOrders")
        })
        ...
        function deleteOrder(value, index){
            let payload = {
                idOrder: value,
                index: index
            }
        ...
        return {
            ...
            user_name,cart, selectAddress,productsOrder, deleteOrder,pageHome, backPage, avatar
        }
    },
    components: {
        HeaderVue
