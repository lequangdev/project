<template>
    <div class="container_admin">
        ...
        <div class="content">
            <div class="titlePage">Quản lý doanh thu</div>
...
import RevenueStatistics from "@/contents/RevenueStatistics.vue"
import { useRouter } from "vue-router";
export default {
    components: {
        HeaderVue,RevenueStatistics
    },
    setup(){
